...
class _CParseTreeVisitor(CVisitor.CVisitor):
    ...
    def visitExternalDeclaration(self, ctx):
        ...
        if ctx.functionDefinition() is not None:
            ...
            for each in decls:
                self._s.child_declaration_list.declarations.add(each)
    ...
    def visitFunctionDefinition(self, ctx):
        ...
        self._s.child_declaration_list.declarations.add(f)
    ...
    def visitPreprocessorDirective(self, ctx):
        ...
        self._s.child_declaration_list.declarations.add(node)
